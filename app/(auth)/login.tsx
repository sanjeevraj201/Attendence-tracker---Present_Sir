    ...
    >
      ...
      >
        ...
        <View className="items-center mb-10">
          ...
          <Text className="text-base text-gray-500 dark:text-gray-400 font-sans mt-2">Sign in to your account</Text>
        </View>

        {error && <StatusBanner type="error" message={error} />}

        <View className="bg-white dark:bg-cardDark p-5 rounded-[24px] shadow-sm dark:shadow-none border border-black/5 dark:border-white/5 mb-6">
        ...
        >
          <Text className="text-primaryOrange font-bold font-sans text-[15px]">Forgot Password?</Text>
        </TouchableOpacity>
        ...
        <View className="flex-row justify-center mt-2">
          <Text className="text-gray-500 dark:text-gray-400 font-sans text-[15px]">Don't have an account? </Text>
          <Link href="/(auth)/signup" asChild>
            <TouchableOpacity>
              <Text className="text-primaryOrange font-bold font-sans text-[15px]">Register</Text>
            </TouchableOpacity>
          </Link>
        </View>
      </ScrollView>
